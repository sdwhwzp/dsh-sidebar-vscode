...
export declare const OPEN_CHANNEL_DIR = "dsh-sidebar-vscode";
/**
 ...
 */
export declare const CHANNEL_FILES: {
    readonly cmd: "cmd.json";
    readonly cap: "cap.json";
    readonly bootreq: "bootreq.json";
    readonly boot: "boot.json";
    readonly editors: "editors.json";
    readonly last: "last.json";
    readonly embed: "embed.json";
    readonly interact: "interact.json";
};
/** Upper bound on every nonce string the routes accept and write. */
export declare const NONCE_MAX_LENGTH = 128;
/**
 ...
 */
export declare const CHANNEL_CAP_V = 5;
/**
 ...
 */
export declare const CHANNEL_CMD_TTL_MS = 600000;
/**
